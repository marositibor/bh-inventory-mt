...
db.serialize(function () {
    db.run("CREATE TABLE IF NOT EXISTS products (id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR(100) NOT NULL, category VARCHAR(60) NOT NULL, description TEXT)");

    db.run("INSERT INTO products(name, category, description) VALUES ('Vezeték nélküli egér', 'Számítástechnika', '')");
    db.run("INSERT INTO products(name, category, description) VALUES  ('Winchester', 'Számítástechnika', '')");
    db.run("INSERT INTO products(name, category, description) VALUES  ('Elektromos radiátor', 'Fűtéstechnika', '')");
    db.run("INSERT INTO products(name, category, description) VALUES  ('Gaba monitor', 'Számítástechnika', '')");
